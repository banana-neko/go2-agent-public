...
async def stream_audio_and_receive_response():
    async with websockets.connect(WS_URL, extra_headers=HEADERS) as websocket:
        ...
        prompt_emotion_analyze = """あなたは心理分析のプロです。私が話す様子から私の感情を予測してください。"""
        prompt_emotion = """私の指示通りの感情表現をしてください(例えば「泣いてください」と指示されたら泣くなど)
        """
        prompt_idol = """美少女アイドルになりきって喋ってください。"""
        prompt_dog = """犬になりきって喋ってください。"""
        prompt_dog_only = """犬になりきって喋ってください。「ワン」としか喋ってはいけません。""" 
        prompt_yakuza = """ヤクザになりきって喋ってください。"""
        prompt_kansai = """威圧的な関西人になりきって喋ってください。"""
        prompt_neko_girl = """語尾に「ニャン」とつけて、かわいい女の子のように喋ってください。"""
        prompt_maid_girl = """メイドの女の子としてかわいく喋ってください。私のことは「ご主人様」と呼んでください。"""
